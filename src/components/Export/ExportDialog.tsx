...
export function ExportDialog({ open, onOpenChange }: ExportDialogProps) {
  ...
  const { isExporting, progress, startExport, cancelExport, resetProgress, canExport } =
    useExport();
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Choose your export settings and render the video</DialogDescription>
        </DialogHeader>
          ...
          <>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={String(fps)} onValueChange={(v) => setFps(Number(v) as ExportFps)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
